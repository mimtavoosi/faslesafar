...
namespace FasleSafar.Data.Services
{
    public class OrderRep:IOrderRep
    {
        ...
        {
            return _context.Orders.Include(o => o.User).Include(o => o.Tour).Include(p=> p.Passengers).OrderByDescending(o => o.OrderId).ToList();
        }
         public List<Order> GetAllPaidOrders()
        {
            return _context.Orders.Where(o=> o.IsFinaly.Contains("پرداخت اقساطی") || o.IsFinaly.Contains("پرداخت نقدی")).Include(o => o.User).Include(o=> o.Tour).Include(p => p.Passengers).OrderByDescending(o => o.OrderId).ToList();
        }
        ...
        public Order GetCurrentOrderByUserId(int userId)
        {
            return _context.Orders.Where(o => o.UserId == userId && o.IsFinaly.Contains("منتظر پرداخت"))
                .Include(d => d.Tour).Include(u=> u.User).Include(p => p.Passengers).OrderByDescending(o=> o.OrderId ).FirstOrDefault();
        }

        public Order GetOrderById(int orderId)
        {
            return _context.Orders.Include(o => o.User).Include(t=> t.Tour).Include(p => p.Passengers).SingleOrDefault(o=> o.OrderId == orderId);
        }
        public List<Order> GetOrdersByUserId(int userId)
        {
            return _context.Orders.Where(o => o.UserId == userId)
                 .Include(d => d.Tour).Include(u=>u.User).Include(p => p.Passengers).ToList();
        }
        ...
        {
            return _context.Orders.Include(o => o.User).Include(o=> o.Tour).Include(p => p.Passengers).OrderByDescending(o => o.OrderId).Skip(skip).Take(20).ToList();
        }
